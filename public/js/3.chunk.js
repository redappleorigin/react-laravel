...
/***/ 599:
/*!*********************************************!*\
  !*** ./resources/react/common/constants.js ***!
  \*********************************************/
...
/***/ 618:
/*!*******************************************************************!*\
  !*** ./resources/react/common/routes/Post/containers/PostPage.js ***!
  \*******************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(/*! ../reducer */ 621);
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return (0, _reducer.selectCurrentPost)(state);
	};
	
	var PostPage = function PostPage(_ref2) {
	    ...
	    return _react2.default.createElement(
	      ...
	      isLoading && _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h2',
	          { className: (0, _aphrodite.css)(styles.loading) },
	          'Loading....'
	        )
	      ),
	      !isLoading && _react2.default.createElement(
	...
	exports.default = (0, _redial.provideHooks)(redial)((0, _reactRedux.connect)(mapStateToProps)(PostPage));

/***/ },

/***/ 619:
/*!*******************************************************!*\
  !*** ./resources/react/common/routes/Post/actions.js ***!
  \*******************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _constants = __webpack_require__(/*! ../../constants */ 599);
	
	function loadPost(slug) {
	  return function (dispatch, getState, _ref) {
	    var axios = _ref.axios;
	    var _getState$sourceReque = getState().sourceRequest;
	    var protocol = _getState$sourceReque.protocol;
	    var host = _getState$sourceReque.host;
	
	    dispatch({ type: _constants.LOAD_POST_REQUEST });
	    return axios.get(protocol + '://' + host + '/api/v0/posts/' + slug).then(function (res) {
	      dispatch({
	        type: _constants.LOAD_POST_SUCCESS,
	        payload: res.data,
	        meta: {
	      ...
	      console.error('Error in reducer that handles ' + _constants.LOAD_POST_SUCCESS + ': ', error);
	      dispatch({
	        type: _constants.LOAD_POST_FAILURE,
	        payload: error,
	        error: true
	      });
	    });
...
/***/ 621:
/*!*******************************************************!*\
  !*** ./resources/react/common/routes/Post/reducer.js ***!
  \*******************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.selectCurrentPost = undefined;
	...
	var _immutable = __webpack_require__(/*! immutable */ 616);
	...
	function currentPost() {
	  ...
	  switch (action.type) {
	    case types.LOAD_POST_REQUEST:
	      return state.withMutations(function (post) {
	        post.set('isLoading', true).set('error', null);
	      });
	    case types.LOAD_POST_SUCCESS:
	      return state.withMutations(function (post) {
	        post.set('title', action.payload.title).set('content', action.payload.content).set('lastFetched', action.meta.lastFetched).set('isLoading', false);
	      });
	...
	var selectCurrentPost = exports.selectCurrentPost = function selectCurrentPost(state) {
	  return state.currentPost.toJS();
	};
